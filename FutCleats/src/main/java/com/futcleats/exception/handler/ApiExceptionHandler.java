...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleDataAlreadyRegistered(FieldNotFoundException ex, WebRequest request) {
    ...
    protected ResponseEntity<Object> handleInvalidData(ReservationNotFoundException ex, WebRequest request) {
        var status = HttpStatus.BAD_REQUEST;
